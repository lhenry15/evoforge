...
from foundry.core.agent_config import AgentConfig


class FoundrySDK:
    """
    Top-level Foundry SDK instance. Created via foundry.init().
    ...
    def bootstrap(self, agent: Callable, source: Any = None, **kwargs: Any) -> Any:
        ...
        """
        from foundry.bootstrap.pipeline import BootstrapPipeline, BootstrapConfig
    ...
    def eval(self) -> Any:
        if self._eval is None:
            from foundry.eval.namespace import EvalNamespace
    ...
    def evolve(self) -> Any:
        if self._evolve is None:
            from foundry.evolution.namespace import EvolveNamespace
    ...
    def data(self) -> Any:
        if self._data is None:
            from foundry.data.namespace import DataNamespace
    ...
    def context(self) -> Any:
        if self._context is None:
            from foundry.context.namespace import ContextNamespace

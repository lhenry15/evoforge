...
from evoforge.training.backends.protocol import FineTuneBackend, TrainingJob
...
class EvolveNamespace:
    ...
    def run_cycle(
        ...
        from evoforge.evolution.engine import _can_fine_tune, _can_auto_promote
        n_trajectories = len(
    ...
    def execute_cycle(
        ...
        if system_prompt is None:
            from evoforge.evolution.engine import _get_system_prompt

...
Thank you for your interest in contributing! EvoForge is an open-source project and
we welcome contributions at all levels.

## Getting Started

```bash
git clone https://github.com/lhenry15/evoforge
cd evoforge
pip install -e ".[dev]"
```
...
- 🐛 **Bug fixes** — check [open issues](https://github.com/lhenry15/evoforge/issues)
- 🔧 **Good first issues** — labeled [`good-first-issue`](https://github.com/lhenry15/evoforge/issues?q=label%3Agood-first-issue)
